...
import FaceReco from './component/FaceReco/FaceReco.component';
import Signin from './component/Signin/Signin.component';
import Register from './component/Register/Register.component';

const app = new Clarifai.App({
  apiKey: '0105363a76184bc385ec08e7e82bba22'
});
...
class App extends React.Component {
  ...
  onButtonSubmit = () => {
    ...
    app.models
      ...
      .then(response => {
        if (response) {
          fetch('https://pacific-bastion-62396.herokuapp.com/image', {
            method: 'put',
